          ...
          <div className="text-center">
            ...
            <div className="bg-gray-50 rounded-2xl p-4 mb-4 space-y-3">
              <div className="flex justify-between text-sm text-gray-600">
                <span>Eligible Items Total:</span>
                <span className="font-semibold">€{eligibleSubtotal.toFixed(2)}</span>
              </div>
              <div className="flex justify-between text-sm text-green-600">
                <span>Meal Voucher Covers:</span>
                <span className="font-semibold">-€{amountPayableByVoucher.toFixed(2)}</span>
              </div>
            ...
            <div className="flex-1 grid grid-cols-1 lg:grid-cols-2 h-full">
              ...
              <div className="bg-white p-8 flex flex-col justify-between">
                <div>
                  ...
                  <div className="space-y-4">
                    ...
                    {/* ADDED: Show user payment amount */}
                    <div className="bg-orange-50 border border-orange-200 rounded-2xl p-4 text-center">
                      <p className="text-sm text-orange-600 font-semibold">You Will Pay</p>
                      <p className="text-3xl font-bold text-orange-700">€{userPayAmount.toFixed(2)}</p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-amber-700 text-sm leading-relaxed">
                        Only the eligible items listed will be processed. Non-eligible items will be dropped from this specific transaction.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="p-8 flex flex-col overflow-hidden">
                <div className="flex-1 overflow-y-auto space-y-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-headingColor mb-4">
                      Non-Eligible Items ({nonEligibleItems.length})
                    </h3>
                    <div className="space-y-4">
                      {dressItems.length > 0 && (
                        <div>
                ...
                <div className="pt-6 border-t border-gray-200 mt-6 flex items-center justify-end space-x-4">
                  <motion.button
                    onClick={onClose}
                    whileTap={{ scale: 0.95 }}
                    className="px-6 py-3 text-textColor bg-gray-200 hover:bg-gray-300 rounded-xl font-semibold"
                  >
                    Cancel
                  </motion.button>
                  <motion.button
